...
public record TaskMedianizedValueFeed(Sdk sdk, String address, ContractAbi abi,
  ...
  public FunctionHandle<Void> updateResponse() {
    Map<String, Object> params = Map.of();
    return new FunctionHandle<Void>(Void.class, sdk(), address(), abi(), credentials(), "updateResponse", params, null);
  }
