...
public record Factory(Sdk sdk, String address, ContractAbi abi,
  ...
  public FunctionHandle<Void> acceptTaskStorageAddress(Address task_, Address taskStorage_) {
    Map<String, Object> params = Map.of("task_", task_, 
        "taskStorage_", taskStorage_);
    return new FunctionHandle<Void>(Void.class, sdk(), address(), abi(), credentials(), "acceptTaskStorageAddress", params, null);
  }
